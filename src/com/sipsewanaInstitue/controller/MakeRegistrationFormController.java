...
import com.sipsewanaInstitue.dto.*;
...
public class MakeRegistrationFormController extends StageList {
    ...
    private void setTblCartCellValue() {
        clmPid.setCellValueFactory(new PropertyValueFactory<CustomDTO, String>("pid"));
    }
    ...
    public void btnAddOnAction(ActionEvent actionEvent) {
        ...
        if (count == -1) {
            tblCart.getItems().add(new CustomDTO(tblProgram.getSelectionModel().getSelectedItem().getPid()));
